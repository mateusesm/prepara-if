                ...
                <div class="container-simulated">
                    ...
                    <form action="analyze-questions.php?modalidade=subsequente-matematica" method="POST">
                        ...
                        <?php
                            ...
                            $selectQuestions = $pdo->prepare("SELECT questoes.id_questao, questoes.questao FROM questoes WHERE questoes.modalidade = 'Subsequente' AND questoes.assunto = 'Matematica' order by RAND()");
                            ...
                            if ($selectQuestions->rowCount()) {
                                ...
                                echo "<input id='submit-questions' type='submit' value='Enviar' name='submit-math-sub'>";
